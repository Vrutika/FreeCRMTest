...
public class ContactsPage extends TestBase {
	...
	public void createnewcontact(String firstname, String lastname, String email, String address, String city,
			String state, String zip, String status, String category, String callstatus) throws InterruptedException {
		...
		act.moveToElement(chkboxdonottext).build().perform();
		if (callstatus.contains("Yes")) {
			chkboxdonottext.click();
		} //end of do not text
